...
class RecipeView extends View {
  ...
  addHandlerUpdateServings(handler) {
    this._parentElement.addEventListener('click', function (e) {
      ...
      // Update servings upon increasing or decreasing the serving number value
  ...
  _generateMarkup() {
    return `
      ...
      <!-- a kis ikonka ha te hoztad letre a receptet jelenjen meg -->
